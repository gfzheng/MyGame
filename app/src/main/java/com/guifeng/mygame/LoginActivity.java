...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResult = (TextView)findViewById(R.id.result_message);
    }
     ...
     */
    private void attemptLogin(boolean bLogin) {
        // Reset error
            ...
            else //register
            {
                ...
                user.save(new VoidCallback() {
                    ...
                    public void onSuccess() {
                        Log.e("MIGA","Saved!");
                        showProgress(false);
                        mResult.setText(getString(R.string.register_ok));
                    }

                    @Override
                    public void onError(Throwable t) {
                        Log.e("MIGA", "Register Failed.", t);
                        showProgress(false);
                        mResult.setText(getString(R.string.register_failed));
                    }
                });
            }
        }
